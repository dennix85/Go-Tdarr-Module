...
type AlterWorkerLimitRequest struct {
	...
	// Use ProcessIncrease or ProcessDecrease.
	Process string `json:"process"`
	// Use WorkerType* constants (e.g. WorkerTypeTranscodeCPU).
...
func (c *Client) PollWorkerLimits(req PollWorkerLimitsRequest) (*PollWorkerLimitsResponse, error) {
	...
	var out PollWorkerLimitsResponse
